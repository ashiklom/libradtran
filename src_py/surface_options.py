...
"""--------------------------------------------------------------------
 * $Id: surface_options.py 3224 2016-06-03 18:36:57Z bernhard.mayer $
 * 
...
class setup_surface_group():
	...
	def __init__(self):
		...
		mc_rpv_file = option(
			...
			gui_inputs=(FileInput(name='Input.rte.mc.filename[FN_MC_RPV_TYPE]'),),
			tokens=addToken( name='Input.rte.mc.filename[FN_MC_RPV_TYPE]', datatype=file ),
			parents=['uvspec'], 
			non_parents=brdf_non_parents,
