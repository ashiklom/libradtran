...
c $Header: /home/users/buras/cvs2svn-2.3.0/cvs/libRadtran/libsrc_f/ErrPack2.f,v 1.5 2007-11-12 17:02:25 ulrich Exp $
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
c        Print out a warning or error message;  abort if error
   ...
   99 FORMAT( //,' >>>>>>  TOO MANY WARNING MESSAGES --  ',
     &   'They will no longer be printed  <<<<<<<', // )
      ...
      LOGICAL FUNCTION  WrtBad2 ( VarNam )
...
c                         ( CHARACTER, any length )
     ...
     &                     '  in error  ****'
      IF ( NumMsg.EQ.MaxMsg )
     &   CALL  ErrMsg2 ('Too many input errors.  Aborting...', .TRUE. )

      RETURN
      END

      LOGICAL FUNCTION  WrtDim2 ( DimNam, MinVal )
...
c                        increased (at least)
     ...
     &                     '  should be increased to at least ', MinVal
      ...
      LOGICAL FUNCTION  TstBad2( VarNam, RelErr )
