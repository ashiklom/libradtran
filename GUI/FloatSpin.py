...
FloatSpin.__init__(self, parent, id, pos=wx.DefaultPosition,
                   ...
                   increment=1.0, digits=2, extrastyle=FS_LEFT,
                   name="FloatSpin")
...
class FloatSpin(wx.PyControl):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        strs = self._textformat.format(float(value))
    ...
    def SetValue(self, value):
        ...
        #print repr(value) #, ("%100." + str(self._digits) + "f") % value
        
        strs = self._textformat.format(float(value))
        strs = strs.strip()
        strs = self.ReplaceDoubleZero(strs)

        if self._isblank and self._textctrl.GetValue() == "":
            return
        else:
            self._isblank = False
    ...
    def SetFormat(self, fmt="{0:100.2f}"):
