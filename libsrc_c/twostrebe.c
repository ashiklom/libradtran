/*--------------------------------------------------------------------
 * $Id: twostrebe.c 3309 2017-10-12 17:39:12Z bernhard.mayer $
 * 
...
static int twostream (double *dtau_org, double *omega0_org, double *g_org, int nlev, 
	       ...
	       float *uavg)
{
  ...
  /* copy double arrays to float arrays */
  ...
  /* call twostream code */
  status = twostream (dtau_org_d, omega0_org_d, g_org_d, nlev, 
		      S0, mu0, Ag, 
		      Bg, B, delta,
		      &Edir, &Edn, &Eup, &Lavg);
